...
where customer.cus_id = $cusid ") or die ($mysqli->error);
                    ...
                    <div class="content">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h4 class="m-2 font-weight-bold text-primary"><?php echo $row['cus_name'];?>&nbsp;</h4>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="dataTable" width="100%" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" border="none" value="<?php echo $row['order_id']; ?>"
