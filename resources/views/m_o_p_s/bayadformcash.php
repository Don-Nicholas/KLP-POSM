                                                ...
                                                <form action="process_bayadcash.php" method="POST">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                    value="<?php echo str_pad($number, 5, "0", STR_PAD_LEFT); ?>"
                                                                    name="ponum" style="width: 200px;" readonly>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" value="<?php echo $cusname; ?>"
                                                                    name="cusname" style="width: 200px;" readonly>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" border="none"
                                                                    value="<?php echo $tot; ?>" name="gtotal" id="txt1"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" border="none" name="discount"
                                                                    id="txt4" style="width: 200px" onkeyup="sum();">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" border="none" name="discamount"
                                                                    id="txt5" style="width: 200px" onkeyup="sum();">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" border="none" name="money" id="txt2"
                                                                    style="width: 200px" onkeyup="sum();">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" border="none" name="change" id="txt3"
                                                                    style="width: 200px;">
                                                            </td>
                                                        </tr>
