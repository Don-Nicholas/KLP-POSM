                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-0">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <?php 
                        $result = $mysqli->query("SELECT COUNT(*) as total FROM customer")or die ($mysqli->error);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-0">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <?php 
                        $result = $mysqli->query("SELECT COUNT(*) as total2  FROM supplier")or die ($mysqli->error);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo $row['total2'];
                          }
                        ?> Record(s)
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-0">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <?php 
                        $result = $mysqli->query("SELECT COUNT(*) as total3  FROM supplier")or die ($mysqli->error);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo $row['total3'];
                          }
                        ?> Record(s)
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-0">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    <?php 
                        $result = $mysqli->query("SELECT COUNT(*) as total4 FROM customer")or die ($mysqli->error);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo $row['total4'];
                          }
                        ?> Record(s)
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">
                                            <?php 
                           $result = $mysqli->query("SELECT COUNT(*) as total5 FROM product")or die ($mysqli->error);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo $row['total5'];
                            }
                          ?> Record(s)
                                ...
                                <div class="h6 mb-0 mr-0 text-gray-800">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            <?php 
                                $result = $mysqli->query("SELECT p_name FROM product")or die ($mysqli->error);
								while ($row = mysqli_fetch_array($result)) 
								{
                                 echo "<a href='#' class='list-group-item text-gray-800'>
                                          <i class='fa fa-tasks fa-fw'></i> ".$row['p_name']."
                                          </a>";
                                  }
                              ?>
                                        </div>
