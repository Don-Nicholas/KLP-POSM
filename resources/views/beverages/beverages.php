...
<?php 
	...
	//require_once('supplier_session.php');
	$result2 = $mysqli->query("SELECT * FROM supplier where sup_id =$suppid") or die ($mysqli->error);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="suppname"
                                                                    value="<?php echo $sname; ?>" style="width: 200px;"
                                                                    readonly>
